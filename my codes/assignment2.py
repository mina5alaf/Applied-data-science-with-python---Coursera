...
def answer_six():
    new_df = census_df[census_df['SUMLEV'] == 50]
    most_populous_counties = new_df.sort_values(
        'CENSUS2010POP', ascending=False).groupby('STNAME').head(3)
...
def answer_eight():
    ...
    grew = washington[washington['POPESTIMATE2015']
                      > washington['POPESTIMATE2014']]
